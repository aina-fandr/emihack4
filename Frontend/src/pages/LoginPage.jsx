...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (email === SIMULATION_CREDENTIALS.email && 
          password === SIMULATION_CREDENTIALS.password) {
        
        const userData = SIMULATION_CREDENTIALS.user;
        localStorage.setItem('token', 'simulation-token-12345');
        ...
        // Rediriger vers Accueil sans délai
        navigate('/accueil', { replace: true });
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <div className="w-full max-w-sm mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1 ml-2">
                  💡 Email: aina@gmail.com | Mot de passe: 26dec2006
                </p>
              </div>
            ...
            <div className="relative flex py-4 items-center">
              ...
              <span className="flex-shrink mx-4 text-slate-500 text-xs font-medium">ou se connecter par</span>
              <div className="flex-grow border-t border-slate-300"></div>
            </div>
